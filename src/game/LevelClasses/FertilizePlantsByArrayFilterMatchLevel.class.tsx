...
import { AnswerInput } from "@/components/InputTabs/AnswerInput";

export class FertilizePlantsByArrayFilterMatchLevel extends ArrayFilterMatchLevel {
  placeholder = [
    () => (
      <>
    ...
    () => (
      <>
        <span className="method pl-8">fertilize</span>
        <span className="casual-token">(</span>
        <span className="identifier">plant</span>
        <span className="casual-token">);</span>
      </>
